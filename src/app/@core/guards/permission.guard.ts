...
export const permissionGuard: CanActivateFn = (next:ActivatedRouteSnapshot, state:RouterStateSnapshot) => {
  ...
  if(requiredPermission&& !_permissionService.hasPermission(requiredPermission)){
