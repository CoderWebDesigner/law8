...
@Component({
  selector: 'app-matter-editor-contract-editor',
  templateUrl: './matter-editor-contract-editor.component.html',
  styleUrls: ['./matter-editor-contract-editor.component.scss']
})
export class MatterEditorContractEditorComponent extends FormBaseClass implements OnInit {
