...
@Component({
  selector: 'app-timesheet-formly-editor',
  templateUrl: './timesheet-formly-editor.component.html',
  styleUrls: ['./timesheet-formly-editor.component.scss']
})
          ...
          fieldGroup: [

            {
              ...
              props: {
                ...
                play: false,
                onPlay: (field, index) => {
                  field.parent.fieldGroup[0].props['play'] = true
                  // console.log(field.parent.parent.fieldGroup)
                  // console.log(index)
                  // console.log(this.formlyModel)
                  this.formlyModel
                  // field.parent.parent.fieldGroup.forEach((element,i) => {
                  //   if(i!=index) element.fieldGroup[0].props['play']=false
                  // });
                  // fieldGroup[0].fieldGroup[0].props.stop
                  // console.log(field.parent.parent.fieldGroup)
